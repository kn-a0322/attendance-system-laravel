...
@section('content')
<div class="admin-stamp-req">
    <div class="admin-stamp-req__header">
        <span class="admin-stamp-req__title-accent" aria-hidden="true"></span>
        <h1 class="admin-stamp-req__heading">申請一覧</h1>
    </div>
