...
<div class="admin-attendance-staff">
    <div class="admin-attendance-staff__header">
        <span class="admin-attendance-staff__title-accent" aria-hidden="true"></span>
        <h1 class="admin-attendance-staff__heading">{{ $user->name }}さんの勤怠</h1>
    </div>
    <nav class="month-nav" aria-label="月の切り替え">
        <a href="{{ route('admin.attendance.staff.show', ['id' => $user->id, 'month' => $prevMonth]) }}" class="month-nav__link month-nav__link--prev">
        ...
        <a href="{{ route('admin.attendance.staff.show', ['id' => $user->id, 'month' => $nextMonth]) }}" class="month-nav__link month-nav__link--next">
            <span>翌月</span>
    ...
    <div class="csv-export">
        <a href="{{ route('admin.attendance.staff.export', ['id' => $user->id, 'month' => $currentMonth->format('Y-m')]) }}" class="csv-export__button">CSV出力</a>
    </div>
</div>
@endsection